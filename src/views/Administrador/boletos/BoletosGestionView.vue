        ...
        <div class="subpanel">
          ...
          <div class="grid">
            ...
            <div>
              ...
              <input v-model.number="equipajeForm.precioExtra" type="number" min="0" step="0.01" style="width:100%" />
            </div>
...
function onAsientoChange() {
  ...
  if (a) {
    ...
    // Si deselecciona (vuelve a "-- Sin asiento --"), limpia el extra
    form.precioAsientoExtra = 0
    recalcular()
  }
}
...
async function submitBoleto() {
  ...
  // ✅ idAsiento ya NO es obligatorio
  ...
  try {
    const payload = {
      ...
      idAsiento:          form.idAsiento ? Number(form.idAsiento) : null,  // ✅ null si vacío
